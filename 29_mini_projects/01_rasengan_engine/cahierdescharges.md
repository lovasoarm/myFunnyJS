...
### `05_math_basics` : les maths qui servent vraiment
...
### `09_functional_js` : coder sans effets de bord
...
### `10_design_patterns` : les recettes qui structurent
...
09_functional_js   --> turnResolver.js (immutabilité, pas de mutation d'état)
...
Le point de résistance majeur est `turnResolver.js`. C'est là que la tentation de muter l'état directement est la plus forte. Si tu sens que tu écris `fighter.chakra -= damages`, arrête-toi et relis le module `09_functional_js`.
