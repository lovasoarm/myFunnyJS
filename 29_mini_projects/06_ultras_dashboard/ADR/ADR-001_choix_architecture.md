...
Le projet couvre `13_typescript`, `25_observability`, `24_scalability`. Le système de types est la contrainte centrale : si un event mal formé traverse le pipeline sans être intercepté, les ultras voient des données corrompues en direct pendant un match — pas acceptable.
