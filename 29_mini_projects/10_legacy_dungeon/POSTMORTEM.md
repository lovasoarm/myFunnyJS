...
(à remplir : un nommage inhabituel, une façon de gérer les erreurs différente de ce que t'as appris dans `03_error_handling`, une organisation de fichiers qui ne suit aucun pattern du curriculum)
...
(à remplir : qu'est-ce qui, dans la méthode de `26_team_craft/04_navigate_codebase.md`, t'a vraiment fait gagner du temps ? Le grep ciblé ? Les tests comme documentation ? Le fait de NE PAS tout lire linéairement ?)
