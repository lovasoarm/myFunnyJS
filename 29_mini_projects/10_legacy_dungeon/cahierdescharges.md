...
`26_team_craft/04_navigate_codebase.md` t'a donné la méthode. Mais une méthode jamais appliquée sur du vrai terrain reste une théorie. Voilà ce que ce projet teste précisément :
...
```
01_fundamentals/08_debugging  --> lire une stack trace dans un contexte inconnu, sans le confort
                                   d'un code que tu as toi-même écrit
03_error_handling             --> comprendre une stratégie de gestion d'erreur que tu n'as pas
                                   choisie, parfois incohérente avec ce que t'as appris ici
11_refactoring/03_code_smells --> reconnaître un smell sans le corriger : la contrainte du
                                   projet t'interdit explicitement le refactoring "pendant que t'y es"
04_testing                    --> lire des tests existants comme documentation du comportement
