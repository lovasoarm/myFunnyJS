...
|---|---|
| `26_team_craft` | navigation de codebase (`04_navigate_codebase.md`) appliquée pour de vrai, ADR rétrospective, technical writing dans MAP.md/POSTMORTEM.md |

Mobilisés en lecture, sans être le coeur du projet : `01_fundamentals/08_debugging` (stack traces inconnues), `03_error_handling` (comprendre une stratégie qu'on n'a pas choisie), `11_refactoring/03_code_smells` (reconnaître sans corriger), `04_testing` (lire des tests existants comme documentation).
