...
C'est exactement ce que `26_team_craft/02_adr_writing.md` enseigne sur les conséquences négatives d'une ADR : elles ne sont pas une erreur de jugement au moment où la décision a été prise. Elles sont le prix qu'on accepte de payer plus tard pour un bénéfice obtenu plus tôt.
