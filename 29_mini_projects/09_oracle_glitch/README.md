...
|---|---|
| `22_ai_native_dev` | Streaming Anthropic, validation Zod, prompt engineering |
| `28_oop_js` | `CodeAnalyzer`, `PromptBuilder`, `OutputValidator` : classes, héritage, mixins |
| `26_team_craft` | ADR pour chaque décision d'architecture, code review outillée |
| `27_edge_cases` | `NaN === NaN`, JSON tronqué, `0.1 + 0.2`, `undefined` dans un array |
