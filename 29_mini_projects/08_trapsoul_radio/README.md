...
|---|---|
| `13_typescript` | Clés de traduction typées, `Track<T>`, types stricts sur tout le player |
| `16_web_concepts` | Browser render pipeline, LCP/CLS optimisés, métadonnées SEO |
| `17_accessibility` | ARIA complet, navigation clavier, contraste WCAG AA vérifié |
| `18_i18n` | 4 locales, `Intl.DateTimeFormat`, pluralisation, fallback |
