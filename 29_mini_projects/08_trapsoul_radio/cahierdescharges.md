...
### `13_typescript` : types stricts, generics, utility types
...
### `16_web_concepts` : browser render pipeline, LCP, INP, CLS
...
### `17_accessibility` : ARIA, navigation clavier, contraste WCAG
...
### `18_i18n` : Intl, pluralisation, namespaces, locale detection
...
```
13_typescript   --> types stricts, TranslationKey typé, Playlist<Track>, Readonly<Config>
16_web_concepts --> LCP < 2.5s, CLS < 0.1, INP < 200ms, metadata dynamiques
17_accessibility --> ARIA roles, navigation clavier, skip links, contraste WCAG AA
18_i18n         --> Intl.DateTimeFormat, Intl.NumberFormat, pluralisation manuelle, 4 locales
```
