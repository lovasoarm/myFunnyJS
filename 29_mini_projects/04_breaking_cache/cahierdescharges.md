...
### `07_data_structures` : graphe et min-heap
...
### `08_algorithms` : Dijkstra, BFS/DFS, tri comparatif, DP
...
### `06_memory_performance` : profilage réel sur chaque algo
...
```
07_data_structures  --> src/graph/ (graphe orienté pondéré), src/heap/ (min-heap)
08_algorithms       --> src/algorithms/ (dijkstra, bfs, mergeSort, quickSort, knapsack)
...
| mergeSort + quickSort | 2h | Faible si le module 08 est bien maîtrisé |
