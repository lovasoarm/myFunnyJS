...
L'objectif pédagogique du projet est explicitement : `07_data_structures` + `08_algorithms` + `06_memory_performance`. Comprendre ces algorithmes de l'intérieur est le point.
