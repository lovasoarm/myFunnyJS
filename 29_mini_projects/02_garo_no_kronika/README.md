...
| `03_error_handling` | `errors/` (erreurs custom typées), propagation dans `missionRunner.js` |
| `19_realtime` | `streamEmitter.js` / `streamReceiver.js` : pattern SSE simulé en JS pur |
| `15_architecture_patterns` | découplage total Conseil/Chevalier via événements (event-driven) |
