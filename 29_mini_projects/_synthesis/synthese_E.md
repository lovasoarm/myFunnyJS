...
> Couvre : `22_ai_native_dev` + `23_databases` + `24_scalability` + `25_observability` + `26_team_craft` + `27_edge_cases` + `28_oop_js`
...
**Du module 24 (scalability) et 25 (observability), ensemble :**
