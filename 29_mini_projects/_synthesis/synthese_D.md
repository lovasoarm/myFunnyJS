...
> Couvre : `14_runtime_env` + `15_architecture_patterns` + `16_web_concepts` + `20_api_craft` + `21_security`
...
**Du module 16 (web concepts) :**
Le cycle de vie HTTP de chaque requête doit suivre le schéma canonique de la charte ASCII (`30_annexes/ascii_charte.md`, schéma 5) : auth, validation, handler, error handler, dans cet ordre, sans exception.
...
**Du module 21 (security), le coeur critique de cette synthèse :**
...
**Du module 15 (architecture patterns) :**
