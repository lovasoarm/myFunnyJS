...
```
14_runtime_env  --> src/cli.js (argv), src/export/csvExporter.js (fs), src/store/jsonStore.js
11_refactoring  --> legacy/ -> src/ (SOLID, séparation des couches)
03_error_handling --> src/errors/ (custom errors), exit codes dans cli.js
30_annexes      --> Dockerfile, .github/workflows/ci.yml
```
