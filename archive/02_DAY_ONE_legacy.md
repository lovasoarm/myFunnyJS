...
>
> Ce fichier reste ici pour référence historique. Ne le lis **pas** en premier.
...
> **Analogie pour le JIT :** t'imagines un chef cuisinier qui prend ta ordre_mission et cuisine exactement ce dont tu as besoin, juste à temps. Ni trop tôt (gâché), ni trop tard (froid).
...
### Étape 1 : Définir le type de jutsu
...
```
Type de jutsu      :  Application web (mobile en version 2 peut-être)
...
```
   ...
   |  (layer jutsu)                   (layer infrastructure)  |
   |                                                            |
...
```
              ...
              données brutes : swipes, matchs, messages, connexions
                              ...
                              v
                        DATA ENGINEER
               Collecte tout ce que l'app jutsu.
...
:::::::::::::::::::::                  ::::::::::::::::::::::::::::::::::::::::
Un client te paie pour                 Tu construis le jutsu, tu vises les
...
Entrepreneur       Tout. Le jutsu, les users, les coûts, la survie.
```
...
L'infrastructure est devenue un jutsu software. Plus personne n'achète des serveurs physiques.
...
```
  ...
  Aucun jutsu dans l'histoire n'a grandi aussi vite.
