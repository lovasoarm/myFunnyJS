...
La règle : TypeScript ajoute des garanties **à la compilation**. JavaScript `#private` ajoute des garanties **au runtime**. Les deux ne sont pas interchangeables. En `29_oop_js/07_encapsulation_privacy`, on explore ça en détail.
