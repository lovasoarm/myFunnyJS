...
```bash
bash .internal/.tools/verification_pack/01_fundamentals/verify.sh solution.js
...
```bash
bash .internal/.tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill fundamentals"
```
