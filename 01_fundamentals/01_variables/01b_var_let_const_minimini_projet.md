...
- Remplace `var` par `let`, relance, et observe la différence : chaque itération crée une nouvelle liaison `i`, capturée telle quelle par sa closure.
