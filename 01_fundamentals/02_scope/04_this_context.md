...
Ce fichier est intentionnellement court. Pourquoi ? Parce que `this` est inséparable du système de prototype et des classes ES6 : tout ça est traité en profondeur dans `28_oop_js/04_this_keyword_rules.md`, au moment où tu auras tous les outils pour vraiment comprendre.
