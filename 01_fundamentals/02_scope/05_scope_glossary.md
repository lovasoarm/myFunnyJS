...
| **Global Scope** | Environnement principal : variables accessibles partout dans le programme | `let hero = "Link";` `function show() { console.log(hero); }` `show(); // Link` | Le couloir principal de l'immeuble : tout le monde y passe / La salle commune d'une auberge : accessible à tous |
