...
Pourquoi ? Parce que dans une vraie application, les données viennent d'une API, l'shinobi interagit, l'interface doit changer. Le navigateur doit **créer du HTML dynamiquement**.
...
Crée un `<input>`. Quand l'shinobi tape un nom, JS crée dynamiquement une carte joueur :
