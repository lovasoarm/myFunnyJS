...
09_functional_js/02_immutability -->  pourquoi la mutation implicite est dangereuse
13_typescript               -->  ce que TS attrape et ce qu'il laisse passer
21_security                 -->  prototype pollution comme vecteur d'attaque réel
```
...
**`21_security` (si pas encore fait) :** la pollution de prototype comme vecteur d'attaque est plus claire après avoir compris la chaîne prototype en profondeur.
