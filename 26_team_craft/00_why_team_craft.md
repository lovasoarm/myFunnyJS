...
-------------------------------------------------
11_refactoring        -->  tu sais ce qui mérite une review sérieuse
12_problem_solving    -->  tu sais pourquoi les décisions d'archi comptent
13_typescript         -->  tu as des types à documenter et des ADR à écrire
14_runtime_env        -->  tu as un environnement à configurer et à documenter
20_api_craft          -->  tu as des endpoints à documenter dans un README
```
...
**25_observability :** un runbook bien écrit s'appuie sur les mêmes réflexes que le technical writing. Les structured logs sont de la documentation machine.
