...
Charger un fichier de 2GB en mémoire pour le lire ligne par ligne : c'est comme avaler tout un repas d'un coup pour savoir si ça a bon goût. Résultat : t'exploites toute la RAM, le processus crash, et le shinobi attend.
