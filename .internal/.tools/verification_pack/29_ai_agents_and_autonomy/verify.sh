#!/usr/bin/env bash
# Drills déterministes pour 29_ai_agents_and_autonomy. Chaque drill compare une sortie
...
echo "== [29_ai_agents_and_autonomy] =="
...
if [ "$fail" -gt 0 ]; then
  echo "== [29_ai_agents_and_autonomy] KO ($fail échec(s)) =="
  exit 1
fi
echo "== [29_ai_agents_and_autonomy] OK =="
