#!/usr/bin/env bash
# Drills déterministes pour 19_web_inclusive. Chaque drill compare une sortie
...
if [ "$fail" -gt 0 ]; then
  echo "== [19_web_inclusive] KO ($fail échec(s)) =="
  exit 1
fi
echo "== [19_web_inclusive] OK =="
