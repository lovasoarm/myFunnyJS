...
// avec des logs structurés (vus dans `25_observability/01_structured_logging`)
...
```
Une fuite mémoire (vue dans `06_memory_performance/04_profiling`) progresse
