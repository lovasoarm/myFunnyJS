...
Ecrire un test qui echoue avant le code, formuler l'assertion la plus specifique possible, c'est un muscle. L'IA t'ecrit vite un test qui passe toujours : ce jeune IA prouve que tu sais ecrire un test qui refuse le mauvais code.
...
```bash
bash .internal/.tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill testing"
```
