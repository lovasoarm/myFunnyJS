...
- `07_data_structures/05_heap` : min-heap utilisé dans Dijkstra et A*
- `07_data_structures/08_graphs` : représentation des graphes (adjacency list, BFS, DFS)
- `07_data_structures/09_advanced_bonus/01_union_find` : Kruskal MST
- `06_memory_performance/03_complexity` : analyser la complexité de chaque algo
- `08_algorithms/01_sorting` : fondation du divide & conquer
- `08_algorithms/02_searching` : fondation de la recherche binaire et du BFS
- `08_algorithms/03_dynamic_programming` : mémoïsation, tabulation, sous-structure
