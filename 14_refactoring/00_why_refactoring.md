...
Oui, explicitement : "10 + 11, Design Patterns + Refacto : sans ça, t'es un risque pour ton équipe". `17_architecture_patterns` dépend directement de `13_design_patterns` ET de `14_refactoring` combinés. Tu ne peux pas construire une architecture clean sans savoir identifier et corriger les smells qui s'accumulent dans un système qui grandit.
