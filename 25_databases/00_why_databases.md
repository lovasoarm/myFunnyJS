...
> Ce module reutilise : async (03_async), scalabilite (26_scalability).
...
Pas dans les 6 blocs prioritaires explicitement listés, mais central dans le mini-projet `05_prison_break_api`, qui combine `21_api_craft`, `22_security`, `25_databases`, et `17_web_concepts` pour une infrastructure complète où la modélisation de données et le cache Redis sont des conditions directes de tenue sous pression du système.
