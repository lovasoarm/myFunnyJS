...
Le pourquoi : ton schéma de DB est aussi important que ton code, donc il doit suivre la même discipline (vu dans `28_team_craft` pour la rigueur d'équipe) : versionné, reviewé, appliqué dans un ordre connu, jamais modifié à la main directement en prod.
