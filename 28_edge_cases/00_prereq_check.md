...
> Ces questions portent sur `27_team_craft`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `27_team_craft/`, ou à sa synthèse `15_team_grimoire.md`.
...
> fin de module, dans `07_edge_cases_grimoire.md`.
