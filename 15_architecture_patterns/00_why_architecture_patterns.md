...
Oui, explicitement : "15 + 20, Architecture + API Craft : sans ça, t'es junior à vie". Le module a un prérequis combiné fort : `10_design_patterns` + `11_refactoring`. Tu ne peux pas construire une architecture solide sans déjà savoir reconnaître les patterns de structure et sans savoir nettoyer du code qui dérive.
