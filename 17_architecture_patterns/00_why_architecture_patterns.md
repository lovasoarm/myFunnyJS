...
> Ce module reutilise : SOLID (12_oop_js), refactoring (14_refactoring).
...
- design patterns créationnels et structuraux : voir `13_design_patterns/`
- principes SOLID (SRP, OCP, DIP) : voir `14_refactoring/02_solid_principles.md`
- comment Node charge un module : voir `16_runtime_env/01_node_vs_browser.md` et `16_runtime_env/03_commonjs_vs_esm.md`
...
Oui, explicitement : "15 + 20, Architecture + API Craft : sans ça, t'es junior à vie". Le module a un prérequis combiné fort : `13_design_patterns` + `14_refactoring`. Tu ne peux pas construire une architecture solide sans déjà savoir reconnaître les patterns de structure et sans savoir nettoyer du code qui dérive.
...
> Ce module réutilise : la composition du module 12 (`12_oop_js`), le refactoring du module 14 (`14_refactoring`).
