...
Prérequis : `02_mvc_pattern.md`, `13_design_patterns/02_structural/02_adapter_pattern.md`, `14_refactoring/02_solid_principles.md`.
...
> La source de vérité pour SRP et couplage est `14_refactoring/02_solid_principles.md`.
> Ici on les applique à l'échelle d'un système entier. On ne les réexplique pas.

> Ce fichier construit directement sur `16_runtime_env`.
> Si tu ne sais pas encore comment Node gère les modules et pourquoi ESM et CJS coexistent :
> fais `16_runtime_env/01_node_vs_browser.md` + `16_runtime_env/03_commonjs_vs_esm.md` avant de continuer.
