...
Prérequis : `01_fundamentals` complet, `13_design_patterns` (notamment observer et factory).
...
Au lieu que le Controller appelle `view.render()` manuellement, le Model peut émettre des événements (Observer Pattern de `13_design_patterns`) :
