...
```
01_fundamentals --> 03_async --> ... --> 31_mini_projects
                                              |
                                              v
                                    [PIOCHE DANS 33_tools]
...
```
31_mini_projects     --> chaque projet démarre plus vite, se débugge plus vite, se mesure plus vite
27_observability      --> tu as déjà manipulé un logger basique, le concept de correlation ID te parle déjà
```
