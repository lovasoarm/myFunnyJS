...
Tu vas croiser l'event loop dans `02_async`, dans `06_memory_performance`, et encore dans `14_runtime_env`.
...
**Référencé dans :** `01_fundamentals/03_functions`, `02_async/04_event_loop`, `27_edge_cases`.
...
**Référencé dans :** `02_async/04_event_loop`, `06_memory_performance/04_profiling`, `19_realtime`.
...
**Référencé dans :** `01_fundamentals/01_variables`, `06_memory_performance/02_copy_vs_ref`.
...
**Référencé dans :** `02_async/02_promises`, `02_async/03_async_await`, `03_error_handling/04_async_error_traps`.
...
**Référencé dans :** `20_api_craft/01_express_from_scratch`, `21_security`, `03_error_handling/03_error_propagation`.
...
**Référencé dans :** `15_architecture_patterns/03_clean_architecture`, `11_refactoring/02_solid_principles`.
...
**Référencé dans :** `16_web_concepts/04_caching_strategies`, `24_scalability/01_load_balancing`.
...
**Référencé dans :** `09_functional_js/06_fp_challenge`, `22_ai_native_dev/03_validate_ai_output`, `25_observability/01_structured_logging`.
