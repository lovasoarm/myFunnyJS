...
13_typescript complet  --> types, interfaces, generics, utility types : la base doit être solide
06_modules              --> import/export, ESM vs CJS : indispensable pour comprendre la résolution de modules en TS
14_runtime_env           --> comprendre Node et CommonJS aide à comprendre pourquoi certaines libs n'ont pas de types ESM propres
```

Ce qui devient plus simple après ce module :
```
21_security              --> tu lis et comprends les types stricts des libs de sécurité sans paniquer
