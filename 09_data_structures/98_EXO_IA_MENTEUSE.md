...
# EXO IA MENTEUSE : module 09_data_structures
...
> indexOf sur un tableau est O(n), pas O(1). L'IA appelle un Set 'array'. Où le nom de structure ment sur la complexité ?
