...
│
└── .internal/                       # NON pédagogique. À ignorer.
    ├── NE_PAS_OUVRIR.md
    ├── CHANGELOG_v19.md             # Historique des versions
    ├── .audit/                      # Rapports internes
    ├── .tools/verification_pack/    # Moteurs verify.sh appelés par les EXO
    └── scripts/                     # Linters mainteneur
```
...
- **`.internal/`** existe pour les mainteneurs. Tu peux ignorer entièrement.
