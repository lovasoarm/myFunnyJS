...
- `CHANGELOG_v19.md` a bougé de la racine à `.internal/CHANGELOG_v19.md`. Sans impact apprenant.
...
- `04_debugging/scenarios/` : `HYPOTHESES.md` désormais obligatoire avant tout édit (verrouillage via verify.sh).
