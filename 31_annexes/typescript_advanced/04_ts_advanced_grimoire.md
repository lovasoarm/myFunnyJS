...
| declaration (compilerOptions) | Génère automatiquement les fichiers .d.ts correspondant à ton code TS, pour les consommateurs externes | `"declaration": true` | publier le plan en même temps que le bâtiment construit / fournir la notice avec le artefact |
