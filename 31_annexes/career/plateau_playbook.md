...
- **Oui, ça n'a rien donné** : ouvre un `EXO_JEUNE_IA.md` du module courant. Demande à l'IA de te poser 3 questions socratiques sur ton blocage : pas de te donner la réponse. Cf `.internal/.tools/verification_pack/_jeune_ia/README.md`. Fin.
