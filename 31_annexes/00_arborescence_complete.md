...
│   ├── 04_error_handling_api.md                               # Les erreurs d'API : status codes, formats d'erreur, middleware global
...
│   └── 09_ai_grimoire.md
│
├── 24_databases/                                               # Persister intelligemment dans le temps : et retrouver rapidement
...
│   └── 06_team_grimoire.md
│
├── 28_edge_cases/                                              # JS qui se rebelle : et comment y survivre
...
│
├── 30_mini_projects/                                           # Assembler tout ça pour de vrai : pas des exercices, des systèmes
...
│
└── 32_tools/                                                   # Les gadgets maison pour aller plus vite : réutilisables dans tous les modules
