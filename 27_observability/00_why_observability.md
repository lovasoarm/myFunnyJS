...
Le dev sans observabilité découvre les problèmes par les plaintes des shinobis, toujours en retard, toujours avec une information incomplète. Un message d'erreur générique sans contexte ("Error: undefined") ne dit rien sur quelle requête, quel shinobi, quelle donnée a déclenché le problème, ce qui transforme chaque debug en enquête longue et frustrante.
