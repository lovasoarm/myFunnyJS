...
Une ordre_mission de Walter White passe par le labo, le grossiste, deux distributeurs intermédiaires, et le point de livraison final. Le tout prend 3 heures au lieu de 30 minutes. Lequel des 5 maillons est lent ? Le correlation ID (vu dans `27_observability/01_structured_logging`) te dit QUE ces logs appartiennent à la même ordre_mission. Il ne te dit PAS où le temps a été perdu.
