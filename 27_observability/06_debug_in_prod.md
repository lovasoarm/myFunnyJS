...
// avec des logs structurés (vus dans `27_observability/01_structured_logging`)
...
// et le bug ne s'est jutsu qu'une seule fois avant de "disparaître"
