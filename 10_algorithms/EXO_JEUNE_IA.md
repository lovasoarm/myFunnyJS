...
```bash
bash .internal/.tools/verification_pack/10_algorithms/verify.sh solution.js
...
```bash
bash .internal/.tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill algorithms"
```
