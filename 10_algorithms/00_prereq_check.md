...
> Ces questions portent sur `09_data_structures`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `09_data_structures/`, ou à sa synthèse `_recall_10.md`.
...
> Ta compréhension est testée en fin de module, dans `07_algorithms_grimoire.md`.
