...
>
> **Budget lecture** : 220 lignes en 15 min chrono. Si tu dépasses, note pourquoi dans `MAP.md`. Objectif progressif : tu dois pouvoir tenir 500 lignes en 15 min à la fin du curriculum.
>
...
On te fournit : une implementation de merge-sort recursive : trace les appels sur [4,1,3,2].
