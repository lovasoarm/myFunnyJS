#!/usr/bin/env bash
# Drills déterministes pour 02_problem_solving. Chaque drill compare une sortie
...
if [ "$fail" -gt 0 ]; then
  echo "== [02_problem_solving] KO ($fail échec(s)) =="
  exit 1
fi
echo "== [02_problem_solving] OK =="
