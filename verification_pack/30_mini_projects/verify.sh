#!/usr/bin/env bash
# Drills déterministes pour 30_mini_projects. Chaque drill compare une sortie
...
if [ "$fail" -gt 0 ]; then
  echo "== [30_mini_projects] KO ($fail échec(s)) =="
  exit 1
fi
echo "== [30_mini_projects] OK =="
