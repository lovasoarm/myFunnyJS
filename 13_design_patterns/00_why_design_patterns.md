...
Oui, explicitement : "10 + 11, Design Patterns + Refacto : sans ça, t'es un risque pour ton équipe". Ce module dépend directement de `11_functional_js` (beaucoup de patterns s'appuient sur le traitement des fonctions comme valeurs), et il devient à son tour un prérequis de `17_architecture_patterns`.
