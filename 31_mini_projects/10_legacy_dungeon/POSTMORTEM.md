...
(à remplir : qu'est-ce qui, dans la méthode de `28_team_craft/04_navigate_codebase.md`, t'a vraiment fait gagner du temps ? Le grep ciblé ? Les tests comme documentation ? Le fait de NE PAS tout lire linéairement ?)
