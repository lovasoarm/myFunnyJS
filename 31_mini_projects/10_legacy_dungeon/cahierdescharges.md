...
`28_team_craft/04_navigate_codebase.md` t'a donné la méthode. Mais une méthode jamais appliquée sur du vrai terrain reste une théorie. Voilà ce que ce projet teste précisément :
