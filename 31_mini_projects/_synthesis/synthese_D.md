...
Le cycle de vie HTTP de chaque requête doit suivre le schéma canonique de la charte ASCII (`32_annexes/ascii_charte.md`, schéma 5) : auth, validation, handler, error handler, dans cet ordre, sans exception.
