...
### `18_accessibility/i18n` : Intl, pluralisation, namespaces, locale detection
...
18_accessibility/i18n         --> Intl.DateTimeFormat, Intl.NumberFormat, pluralisation manuelle, 4 locales
```
