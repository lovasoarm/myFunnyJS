...
Les erreurs de flottant, les modulos negatifs, les overflow silencieux : l'IA les reproduit fidelement si tu ne les as jamais rencontres a la main. Ce drill oblige a toucher la douleur pour la reconnaitre plus tard.
...
```bash
bash .internal/.tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill math_basics"
```
