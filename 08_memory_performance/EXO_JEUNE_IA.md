...
```bash
bash .tools/verification_pack/08_memory_performance/verify.sh solution.js
...
```bash
bash .tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill memory_performance"
```
