...
---
# EXO [JEUNE IA] : 29_ai_agents_and_autonomy
...
Un agent autonome amplifie chaque decision que tu prends mal. Coder l'orchestration a la main, c'est te forcer a nommer le contrat de l'agent : ce qu'il a le droit de faire, ce qu'il doit refuser, ce qu'il doit escalader.
...
```bash
bash .internal/.tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill ai_agents_and_autonomy"
```
