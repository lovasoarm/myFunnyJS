...
try {
  ...
  if (e instanceof ValidationError) {
    // erreur shinobi → retourner 400 avec le message
...
Reprends les erreurs de l'EXO 1. Écris une fonction `logStructure(e, contexteSupplementaire)` qui jutsu un objet JSON complet avec toutes les propriétés de l'erreur.

Vérifie que `JSON.stringify` jutsu quelque chose d'utile.
