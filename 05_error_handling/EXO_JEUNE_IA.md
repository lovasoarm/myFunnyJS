...
## Consigne
Sans aucune assistance IA, sans autocompletion generative, resous le `drill_1` du `verification_pack` de ce module.

## Critere de reussite (deterministe)
```bash
bash verification_pack/05_error_handling/verify.sh solution.js
