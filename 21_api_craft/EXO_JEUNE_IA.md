...
```bash
bash .internal/.tools/verification_pack/21_api_craft/verify.sh solution.js
...
```bash
bash .internal/.tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill api_craft"
```
...
2. Ecris le critere binaire de reussite (une tache, une sortie attendue).
