...
Indirectement essentiel : `09_functional_js` dépend de `01_fundamentals/03_functions`, et devient à son tour le prérequis direct de `10_design_patterns`. Beaucoup de design patterns modernes (Strategy, par exemple) s'appuient sur des fonctions traitées comme des valeurs interchangeables, ce qui est un réflexe purement fonctionnel.
