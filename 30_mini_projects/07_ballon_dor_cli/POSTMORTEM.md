...
Les tests de caractérisation sur la v1 ont été la meilleure décision du projet. Ils ont permis de refactorer sans peur : tant que les tests de caractérisation passent, le comportement observable n'a pas changé. La v2 peut restructurer tout l'intérieur sans que l'shinobi voit la différence.
