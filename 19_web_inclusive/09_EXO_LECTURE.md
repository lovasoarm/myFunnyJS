...
Si ton hypothèse était fausse, tant mieux : tu viens d'apprendre où ton modèle mental cloche sur Web Inclusive. Un dev qui lit vite mais faux est plus dangereux qu'un dev lent mais juste.
