...
Pas dans les 6 blocs prioritaires explicitement listés, mais directement intégré dans le mini-projet `08_trapsoul_radio`, qui combine `13_typescript`, `16_web_concepts`, `17_accessibility`, et `18_i18n` pour une plateforme qui doit gérer plusieurs langues avec pluralisation et formats corrects par locale, en plus d'être accessible.
