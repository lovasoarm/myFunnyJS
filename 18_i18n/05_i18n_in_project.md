...
Un utilisateur français télécharge aussi les traductions japonaises et malgaches qu'il n'utilisera jamais. Sur une grosse app avec 10 langues, ça peut représenter des centaines de Ko inutiles, ce qui touche directement le LCP (Largest Contentful Paint) du module 06_memory_performance.
...
```js
// Script de vérification à lancer en CI (intégration continue, voir module 30_annexes)
