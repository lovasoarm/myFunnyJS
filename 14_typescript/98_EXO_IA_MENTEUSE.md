...
# EXO IA MENTEUSE : module 14_typescript
...
```js
function get<T>(o: any, k: string): T { return o[k] as T }  // 'type-safe'
```
...
> 'as T' est un cast, pas une vérification. Rien ne prouve que o[k] est un T. Où est la vraie sécurité de type dans ce code (spoiler : nulle part) ?
