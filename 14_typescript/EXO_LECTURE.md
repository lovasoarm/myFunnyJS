# EXO LECTURE : 15 minutes (TypeScript)

Compétence : lire du code réel que tu n'as pas écrit et le comprendre AVANT de le modifier. C'est 80% du métier.

## L'extrait

On te fournit un extrait TS avec types conditionnels, `infer`, discriminated union ou template literal types : issu de `14_typescript/06_advanced/`. 15-30 minutes de lecture, pas plus.
...
Si ton hypothèse était fausse, tant mieux : tu viens d'apprendre où ton modèle mental cloche sur TypeScript. Un dev qui lit vite mais faux est plus dangereux qu'un dev lent mais juste.
