...
Pas dans les 6 blocs prioritaires explicitement listés, mais c'est un module qui s'intègre directement dans des projets réels : le mini-projet `08_trapsoul_radio` combine `13_typescript`, `16_web_concepts`, `17_accessibility`, et `18_i18n` pour construire une plateforme qui doit fonctionner "au clavier, à la souris, aux lecteurs d'écran, et en plusieurs langues" : l'accessibilité n'est pas optionnelle dans ce genre de projet, c'est une condition de livraison.
