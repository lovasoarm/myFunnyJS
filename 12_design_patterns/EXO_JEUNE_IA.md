...
---
# EXO [JEUNE IA] : 12_design_patterns
...
```bash
bash .internal/.tools/verification_pack/_jeune_ia/run_fasting_drill.sh 45 "drill design_patterns"
```
