#!/usr/bin/env bash
# Drills déterministes pour 17_web_concepts. Chaque drill compare une sortie
...
if [ "$fail" -gt 0 ]; then
  echo "== [17_web_concepts] KO ($fail échec(s)) =="
  exit 1
fi
echo "== [17_web_concepts] OK =="
